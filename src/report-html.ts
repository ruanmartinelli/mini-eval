...
const STYLES = `
    :root {
      ...
      --bg: #fafafa; --card: #fff; --fg: #1a1a1a; --muted: #6b7280;
      --border: #e5e7eb; --accent: #2563eb; --hover:rgb(234, 234, 234);
      --good: #16a34a; --ok: #d97706; --bad: #dc2626;
    }
    @media (prefers-color-scheme: dark) {
      :root {
        --bg: #0b0d10; --card: #14171c; --fg: #e6e8eb; --muted: #9aa3af;
        --border: #262b33; --accent: #60a5fa; --hover: #1b2027;
    ...
    * { box-sizing: border-box; }
    ...
    h2 { font-size: 12px; font-weight: 500;  letter-spacing: 0.05em; color: var(--muted); margin: 0 0 12px; }
    .card { background: var(--card); border: 1px solid var(--border); border-radius: 12px; corner-shape: superellipse(1.25); overflow: hidden; }
